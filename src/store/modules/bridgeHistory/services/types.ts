...
type BridgeType = "polynetwork" | "ibc";
type BridgeBlockchain = "bsc" | "eth" | "carbon" | "polygon";

export interface BridgeRelayParams {
  bridgeType: BridgeType;
  sourceBlockchain?: BridgeBlockchain;
  destinationBlockchain?: BridgeBlockchain;
  searchTerm?: string;
}
