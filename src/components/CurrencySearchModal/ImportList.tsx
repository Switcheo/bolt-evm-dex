...
import { enableList, removeList } from "../../store/modules/lists/actions";
import { useAllLists } from "../../store/modules/lists/hooks";
    ...
    <Wrapper>
      ...
      <PaddedColumn gap="md">
        <AutoColumn gap="md">
          ...
          <Card style={{ backgroundColor: transparentize(0.8, theme?.red1 ?? "#FD4040") }}>
