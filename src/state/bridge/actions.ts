...
export const selectTokenCurrency = createAction<Token>('bridge/selectTokenCurrency')
...
export interface BridgeableTokenActions {
  pending: ActionCreatorWithPayload<{ tokensUrl: string; bridgesUrl: string; requestId: string }>
  ...
  rejected: ActionCreatorWithPayload<{ tokensUrl: string; bridgesUrl: string; errorMessage: string; requestId: string }>
}
