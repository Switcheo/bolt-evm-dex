...
export const issueSlice = createSlice({
  ...
  reducers: {
    optsSet: (
      state,
      action: PayloadAction<Required<KindedOptions["ERC20"]>>,
    ) => {
...
export const { optsSet, codeSet, highlightedCodeSet, compilingSet } =
  issueSlice.actions;
...
export const selectHighlightedCode = (state: AppState) =>
  state.issue.highlightedCode;
